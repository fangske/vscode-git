...
describe('TodoDataService', () => {
  ...
  it('should return some values', inject([TodoDataService], (service: TodoDataService) => {
  ...
  describe('A code-challenge scenario', () => {

    it('should return the number of records', inject([TodoDataService], (service: TodoDataService) => {
     let todo = new Todo({title: 'daimler', complete: false});
     service.addTodo(todo);
